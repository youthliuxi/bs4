...
def insert(x):
	...
	for link in a:
		...
		query = "insert into `imooc_note_N_g_t` values(0,'"+MySQLdb.escape_string(insert_title)+"','"+MySQLdb.escape_string(insert_author)+"','"+MySQLdb.escape_string(insert_content)+"');"
		# print(query)
